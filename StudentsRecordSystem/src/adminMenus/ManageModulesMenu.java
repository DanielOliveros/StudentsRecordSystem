...
public class ManageModulesMenu implements Menu{
	...
	public void addModule(){
		String name, id, description, programId, idLecturer;
		int credits;
		boolean error = true;
		...
		while(error == true){
			...
			programId = scan.nextLine();
			System.out.println("Please introduce allocated Lecturer's id: ");
			idLecturer = scan.nextLine();
			if(ManageModules.addModule(id, name, credits, description, programId, idLecturer)!= null){
