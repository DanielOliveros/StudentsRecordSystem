...
public class ManageModules {
	public static Module addModule(String id, String name, int credits, String description, String idProgram, String lecturerId){
		Module module;
		if(DAOModule.getModule(id)==null){
			module = new Module(id, name, credits, description, idProgram, lecturerId);
